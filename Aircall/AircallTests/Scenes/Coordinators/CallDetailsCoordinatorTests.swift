//
//  CallDetailsCoordinatorTests.swift
//  AircallTests
//
...
class CallDetailsCoordinatorTests: XCTestCase {
	...
	func testInit() {
		...
		// Create dummy call identifier.
		let callId: Int = 666

		// Create dummy coordinator
		let coordinator = CallDetailsCoordinator(
		...
		XCTAssertEqual(coordinator.callId, 666)
	}
